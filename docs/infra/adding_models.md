...
```python
# easymlx/modules/my_model/my_model_configuration.py
...
```python
# easymlx/modules/my_model/modeling_my_model.py
...
class MyModelForCausalLM(EasyMLXBaseModule):
    ...
    def __init__(self, config: MyModelConfig, **kwargs):
        ...
        # ... define layers (attention, MLP, norm, etc.) ...
...
```python
# easymlx/modules/my_model/__init__.py
from .my_model_configuration import MyModelConfig
