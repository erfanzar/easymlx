...
class SpeculativeConfig:
    ...
    Attributes:
        ...
        speculative_model: Path or identifier for the draft model used
            in speculative decoding. ``None`` disables speculative decoding.
    """
    ...
    def use_eagle(self) -> bool:
        """Determine whether EAGLE-style speculative decoding is enabled.

        Returns:
            ``True`` if both ``num_speculative_tokens > 0`` and a
            ``speculative_model`` is configured.
        """
