    ...
    def finish_request(
        ...
        *,
        ...
        with self._lock:
            ...
            self.total_tokens_generated += max(int(completion_tokens), 0)
    ...
    def snapshot(
        ...
        *,
        ...
        with self._lock:
            ...
            average_tps = (
                float(self.total_tokens_generated) / self.total_generation_seconds
                if self.total_generation_seconds > 0
                else 0.0
            )
            return {
