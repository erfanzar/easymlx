...
This is the most common reasoning format, also used as the default fallback
by ``detect_reasoning_parser`` for model families that use ``<think>``/``</think>``
tags (Qwen2, Phi, Llama, Gemma, Cohere, etc.).
"""
