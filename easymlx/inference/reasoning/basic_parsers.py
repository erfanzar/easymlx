...
class BaseThinkingReasoningParser(ReasoningParser):
    ...
    def _is_prompt_reasoning_active(self) -> bool:
        """Check if reasoning mode is active (either prompt-inferred or manual override).

        Returns:
            ``True`` if the prompt started a reasoning block or if
            ``assume_reasoning`` was set manually.
        """
