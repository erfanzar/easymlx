...
class MinimaxToolParser(ToolParser):
    ...
    def preprocess_model_output(self, model_output: str) -> str:
        ...
        def remove_tool_calls_from_think(match):
            ...
            Args:
                match: A regex match object containing the think section content
                    in group(1).

            Returns:
                The think section with any embedded tool_calls blocks removed,
                re-wrapped in <think>...</think> tags.
            """
