...
class Scheduler:
    ...
    def _admit_waiting(self, *, allow_preemption: bool = True) -> tuple[list["str"], list["str"]]:
        ...
        while self.waiting and len(self.running) < self.max_num_running_reqs:
            ...
            try:
                ...
                if preemption_happened or not allow_preemption:
    ...
    def schedule(
        ...
        *,
        ...
        blocked_request_ids = blocked_request_ids or frozenset()
        preempted_ids, newly_running_ids = self._admit_waiting(allow_preemption=allow_preemption)
