...
"""Abstract base classes for tool call parsing in EasyMLX inference.
...
Example:
    ...
    >>> from easymlx.inference.tools.abstract_tool import ToolParser, ToolParserManager
    >>>
...
See Also:
    - easymlx.inference.tools.parsers: Model-specific parser implementations
    - easymlx.inference.tools.utils: Utility functions for parsing
"""
...
class ToolParser:
    ...
    Example:
        ...
        >>> from easymlx.inference.tools import HermesToolParser
...
class ToolParserManager:
    ...
    def available_parsers(cls) -> tuple[str, ...]:
        """Return registered parser names sorted alphabetically."""
        return tuple(sorted(cls.tool_parsers))
    ...
    def import_tool_parser(cls, plugin_path: str) -> None:
        ...
        Example:
            ...
            >>> # custom_parser.py
            >>> from easymlx.inference.tools import ToolParser, ToolParserManager
            >>>
