...
"""EasyMLX Inference Tools Module.
...
tool calling functionality in EasyMLX inference servers.
...
Usage:
    ...
    >>> from easymlx.inference.tools import ToolParserManager, HermesToolParser
    >>>
    ...
    >>> from easymlx.inference.tools import ToolCallingMixin
    >>>
...
See Also:
    - easymlx.inference.tools.abstract_tool: Base classes for tool parsers
    - easymlx.inference.tools.parsers: Model-specific parser implementations
    - easymlx.inference.tools.tool_calling_mixin: Mixin for inference servers
