...
See Also:
    - easymlx.inference.tools.abstract_tool.ToolParser: Base parser class
    - easymlx.inference.tools.abstract_tool.ToolParserManager: Parser registry
"""
...
logger = logging.getLogger("ToolCallingMixin")
